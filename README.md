...
`translation.language` でプラグインが生成する表示文を切り替えられます。
...
- 外務省 海外安全情報: 日本人・日本語利用者向けの海外安全情報です。
- P2P地震情報: 気象庁由来の日本国内向け地震・津波・緊急地震速報を扱います。
- 震度表記、都道府県フィルター: 日本向けの概念です。

汎用部分:

- RSS/Atom: 任意のフィードURLを設定できるため、日本固有ではありません。
